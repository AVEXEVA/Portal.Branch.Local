      ...
      <div class='card card-primary'>
        <div class='card-heading'>
          <div class='row g-0 px-3 py-2'>
            ...
            <div class='col-6 col-lg-3'>
                <div class='row g-0'>
                  <div class='col-4'><button class='form-control rounded' onClick="document.location.href='employee.php?ID=<?php echo !is_null( $Employee[ 'ID' ] ) ? array_keys( $_SESSION[ 'Tables' ][ 'Employees' ], true )[ array_search( $User[ 'ID' ], array_keys( $_SESSION[ 'Tables' ][ 'Employees' ], true ) ) - 1 ] : null;?>';"><?php \singleton\fontawesome::getInstance( 1 )->Previous( 1 );?><span class='desktop'> Previous</span></button></div>
                  <div class='col-4'><button class='form-control rounded' onClick="document.location.href='employees.php?<?php echo http_build_query( is_array( $_SESSION[ 'Tables' ][ 'Users' ][ 0 ] ) ? $_SESSION[ 'Tables' ][ 'Employees' ][ 0 ] : array( ) );?>';"><?php \singleton\fontawesome::getInstance( 1 )->Table( 1 );?><span class='desktop'> Table</span></button></div>
                  <div class='col-4'><button class='form-control rounded' onClick="document.location.href='employee.php?ID=<?php echo !is_null( $Employee[ 'ID' ] )? array_keys( $_SESSION[ 'Tables' ][ 'Employees' ], true )[ array_search( $User[ 'ID' ], array_keys( $_SESSION[ 'Tables' ][ 'Employees' ], true ) ) + 1 ] : null;?>';"><?php \singleton\fontawesome::getInstance( 1 )->Next( 1 );?><span class='desktop'> Next</span></button></div>
                </div>
            </div>
          </div>
        </div>
