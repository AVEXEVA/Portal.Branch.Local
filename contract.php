        	...
        	<div class='card card-primary'>
        		<div class='card-heading'>
        			<div class='row g-0 px-3 py-2'>
        				<div class='col-6'><h5><?php \singleton\fontawesome::getInstance( )->Customer( 1 );?><a href='contracts.php?<?php echo isset( $_SESSION[ 'Tables' ][ 'Contacts' ][ 0 ] ) ? http_build_query( is_array( $_SESSION[ 'Tables' ][ 'Contacts' ][ 0 ] ) ? $_SESSION[ 'Tables' ][ 'Contracts' ][ 0 ] : array( ) ) : null;?>'>Contracts</a>: <span><?php echo is_null( $Contract[ 'ID' ] ) ? 'New' : $Contract[ 'Name' ];?></span></h5></div>
        				<div class='col-2'></div>
        				<div class='col-2'>
        					<div class='row g-0'>
