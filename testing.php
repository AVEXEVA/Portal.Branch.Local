...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    if(	!isset($My_Connection['ID']) 
		...
		sqlsrv_query($NEI,"
			...
			VALUES(?,?,?)
		;",array($_SESSION['User'],date("Y-m-d H:i:s"), "routes.php"));
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body onload="finishLoadingPage();">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3><?php \singleton\fontawesome::getInstance( )->Testing();?>Testing Department
                            </h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="basic-pills">
                                    <div class="flot-chart"><div class="flot-chart-content" id="flot-placeholder-testing-jobs"></div></div>
                                    <br />
                                    <div class='row'>
                                        <div class='col-md-6'><div class="flot-chart"><div class="flot-chart-content" id="flot-pie-chart-testing-jobs-by-supervisor"></div></div></div>
                                        <div class='col-md-6'><h4>Below this pie chart is as of 3/30/2017 Paperless Time Tickets</h4><div class="flot-chart"><div class="flot-chart-content" id="flot-pie-chart-testing-jobs-hours-by-supervisor"></div></div></div>
                                    </div>
                                </div>
                                <div class="tab-pane fade in" id="financials-pills">
                                    <div class="flot-chart"><div class="flot-chart-content" id="flot-placeholder-testing-profit"></div></div>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php 
                                                    $r = sqlsrv_query($NEI,"
                                                        ...
                                                        WHERE Invoice.fDate >= '2012-01-01 00:00:00.000' AND Invoice.fDate < '2013-01-01 00:00:00.000' AND Job.Type = '8'
                                                    ;");
                                                ...
                                                <td><?php 
                                                    $r = sqlsrv_query($NEI,"
                                                        ...
                                                        FROM 
                                                            ...
                                                            LEFT JOIN nei.dbo.Loc ON Invoice.Loc = Loc.Loc)
                                                            LEFT JOIN nei.dbo.Job ON Invoice.Job = Job.ID
                                                        WHERE Invoice.fDate >= '2013-01-01 00:00:00.000' AND Invoice.fDate < '2014-01-01 00:00:00.000' AND Job.Type = '8'
                                                    ;");
                                                ...
                                                <td><?php 
                                                    $r = sqlsrv_query($NEI,"
                                                        ...
                                                        FROM 
                                                            ...
                                                            LEFT JOIN nei.dbo.Loc ON Invoice.Loc = Loc.Loc)
                                                            LEFT JOIN nei.dbo.Job ON Invoice.Job = Job.ID
                                                        WHERE Invoice.fDate >= '2014-01-01 00:00:00.000' AND Invoice.fDate < '2015-01-01 00:00:00.000' AND Job.Type = '8'
                                                    ;");
                                                ...
                                                <td><?php 
                                                    $r = sqlsrv_query($NEI,"
                                                        ...
                                                        FROM 
                                                            ...
                                                            LEFT JOIN nei.dbo.Loc ON Invoice.Loc = Loc.Loc)
                                                            LEFT JOIN nei.dbo.Job ON Invoice.Job = Job.ID
                                                        WHERE Invoice.fDate >= '2015-01-01 00:00:00.000' AND Invoice.fDate < '2016-01-01 00:00:00.000' AND Job.Type = '8'
                                                    ;");
                                                ...
                                                <td><?php 
                                                    $r = sqlsrv_query($NEI,"
                                                        ...
                                                        FROM 
                                                            ...
                                                            LEFT JOIN nei.dbo.Loc ON Invoice.Loc = Loc.Loc)
                                                            LEFT JOIN nei.dbo.Job ON Invoice.Job = Job.ID
                                                        WHERE Invoice.fDate >= '2016-01-01 00:00:00.000' AND Invoice.fDate < '2017-01-01 00:00:00.000' AND Job.Type = '8'
                                                    ;");
                                                ...
                                                <td><?php 
                                                    $r = sqlsrv_query($NEI,"
                                                        ...
                                                        FROM 
                                                            ...
                                                            LEFT JOIN nei.dbo.Loc ON Invoice.Loc = Loc.Loc)
                                                            LEFT JOIN nei.dbo.Job ON Invoice.Job = Job.ID
                                                        WHERE Invoice.fDate >= '2017-01-01 00:00:00.000' AND Invoice.fDate < '2018-01-01 00:00:00.000' AND Job.Type = '8'
                                                    ;");
                                                ...
                                                <td><?php 
                                                    $r = sqlsrv_query($NEI,"
                                                        ...
                                                        FROM 
                                                            ...
                                                            LEFT JOIN nei.dbo.Loc ON Invoice.Loc = Loc.Loc)
                                                            LEFT JOIN nei.dbo.Job ON Invoice.Job = Job.ID
                                                        WHERE Invoice.fDate >= '2015-01-01 00:00:00.000' AND Invoice.fDate < '2018-01-01 00:00:00.000' AND Job.Type = '8'
                                                    ;");
                                                ...
                                                <td><?php 
                                                    $r = sqlsrv_query($NEI,"
                                                        ...
                                                        FROM 
                                                            ...
                                                            LEFT JOIN nei.dbo.Loc ON Invoice.Loc = Loc.Loc)
                                                            LEFT JOIN nei.dbo.Job ON Invoice.Job = Job.ID
                                                        WHERE Invoice.fDate >= '2013-01-01 00:00:00.000' AND Invoice.fDate < '2018-01-01 00:00:00.000' AND Job.Type = '8'
                                                    ;");
    ...
    <?php require(PROJECT_ROOT."js/chart/testing_profit.php");?>
