...
<body style="min-height:100%;background-size:cover;background-color:rgba(255,255,255,.7);height:100%;color:black !important;">
                    ...
                    <div class="card" style="width: 103rem;">
                        <div class="card-body">
                            ...
                            <div class='row'>
                                ...
                                <div class='col-1' style='background-color:red;'>PTO</div>
                                <div class='col-1' style='background-color:#282828;color:white;'>Weekend</div>
                                <div class='col-2' style='background-color:blue;color:white;'>Scheduled</div>
                                <div class='col-2' style='background-color:purple;color:white;'>Worked on Schedule</div>
                            </div>
                            <div class='row'>
                                <div class='col-12'>
