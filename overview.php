                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3><?php $Icons->Modernization();?>Company Overview
                            </h3>
                        </div>
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                ...
                                <li class=""><a href="#revenue-pills" data-toggle="tab"><?php $Icons->Info();?> Revenue</a></li>
                                <li class=""><a href="#financials-pills" data-toggle="tab"><?php $Icons->Financial();?> Financials</a></li>
                                <li class=""><a href="#departments-pills" data-toggle="tab"><?php $Icons->Financial();?> Departments</a></li>
                            </ul>
                            <br />
