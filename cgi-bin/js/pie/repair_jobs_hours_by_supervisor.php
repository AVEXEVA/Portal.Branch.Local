...
$(function() {
    var data43 = [<?php 
        ...
        $job_result = sqlsrv_query($NEI,"
            ...
            WHERE (Job.Type='3' OR Job.Type='6') AND TicketD.EDate >= '2017-03-30 00:00:00.000' AND TicketD.Total <= 24
        ...
        echo implode(",",$data2);?>];
    var plotObj3 = $.plot($("#flot-pie-chart-repair-jobs-hours-by-supervisor"), data43, {
        series: {
            pie: {
                show: true
            }
