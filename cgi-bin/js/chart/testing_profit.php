...
function gd(year, month, day) {
    ...
    var testing_profit_dataset = [
    {
        label: "Profit",
        data: testing_profit_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-testing-profit"), testing_profit_dataset, testing_profit_options);
    $("#flot-placeholder-testing-profit").UseTooltip();
});
