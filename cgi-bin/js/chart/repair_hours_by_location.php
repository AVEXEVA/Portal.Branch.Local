...
function gd(year, month, day) {
    ...
    var repair_hours_dataset = [
    {
        label: "Hours",
        data: repair_hours_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-repair-hours-by-customer"), repair_hours_dataset, repair_hours_options);
    $("#flot-placeholder-repair-hours-by-customer").UseTooltip();
});
