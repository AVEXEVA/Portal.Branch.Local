...
function gd(year, month, day) {
    ...
    var repair_profit_dataset = [
    {
        label: "Profit",
        data: repair_profit_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-repair-profit"), repair_profit_dataset, repair_profit_options);
    $("#flot-placeholder-repair-profit").UseTooltip();
});
