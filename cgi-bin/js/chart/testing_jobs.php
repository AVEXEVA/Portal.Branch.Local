...
function gd(year, month, day) {
    ...
    var testing_jobs_dataset = [
    {
        label: "Count of Jobs",
        data: testing_jobs_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-testing-jobs"), testing_jobs_dataset, testing_jobs_options);
    $("#flot-placeholder-testing-jobs").UseTooltip();
});
