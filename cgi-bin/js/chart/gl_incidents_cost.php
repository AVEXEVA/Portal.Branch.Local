...
function gd(year, month, day) {
    ...
    var gl_incidents_cost_dataset = [
    {
        label: "Profit",
        data: gl_incidents_cost_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-gl-incidents-cost"), gl_incidents_cost_dataset, gl_incidents_cost_options);
    $("#flot-placeholder-gl-incidents-cost").UseTooltip();
});
