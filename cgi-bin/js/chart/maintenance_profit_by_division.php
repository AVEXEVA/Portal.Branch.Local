    ...
    <?php 
        ...
        if($job_result){
            ...
            foreach($totals as $Division=>$array){
                $data5 = array();
                ?>var data_maintenance_profit_by_<?php echo $Division;?> = [<?php
            ...
            var dataset_maintenance_profit_by_division = [<?php 
            $i = 0;
            foreach($totals as $Division=>$array){
                $i++;
                ...
                ?>{
                    ...
                    data: data_maintenance_profit_by_<?php echo $Division;?>,
...
var options_maintenance_profit_by_division = {
    series: {
        shadowSize: 5
    },
    xaxes: [{
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-maintenance-profit-by-division"), dataset_maintenance_profit_by_division, options_maintenance_profit_by_division);
    $("#flot-placeholder-maintenance-profit-by-division").UseTooltip();
});
