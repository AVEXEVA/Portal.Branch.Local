...
function gd(year, month, day) {
    ...
    <?php 
        ...
        $job_result = sqlsrv_query($NEI,"
            SELECT Job.Custom1 AS Supervisor, TicketD.Total as Total, TicketD.EDate AS Dated
            FROM 
                (((TicketD 
        ...
        if($job_result){
            ...
            foreach($data3 as $Division=>$array){
                ksort($array);
                $data = array();
                ?>var data_modernization_hours_by_<?php echo $Division;?> = [<?php 
    ...
    var dataset_modernization_hours_by_supervisor = [<?php 
        $i = 0;
        foreach($data3 as $Division=>$array){
            $i++;
            ...
            ?>{
                ...
                data: data_modernization_hours_by_<?php echo $Division;?>,
...
var options_modernization_hours_by_supervisor = {
    series: {
        shadowSize: 5
    },
    xaxes: [{
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-modernization-hours-by-supervisor"), dataset_modernization_hours_by_supervisor, options_modernization_hours_by_supervisor);
    $("#flot-placeholder-modernization-hours-by-supervisor").UseTooltip();
});
