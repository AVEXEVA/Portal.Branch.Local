...
function gd(year, month, day) {
    ...
    var other_profit_data = [
        ...
        if($job_result){
            ...
            $invoice_result = $database->query(null,"
                ...
                WHERE
                    (Job.Type = '14' OR Job.Type = '4' OR Job.Type = '15' OR Job.Type = '16' OR Job.Type = '11' OR Job.Type = '13' OR Job.Type = '17' OR Job.Type = '18' OR Job.Type = '19' OR (Job.Type = '' AND Job.Type <> 0) OR (Job.Type = ' ' AND Job.Type <> 0))
    ...
    var other_profit_dataset = [
    {
        label: "Profit",
        data: other_profit_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-other-profit"), other_profit_dataset, other_profit_options);
    $("#flot-placeholder-other-profit").UseTooltip();
});
