...
function gd(year, month, day) {
    ...
    var modernization_hours_dataset = [
    {
        label: "Profit",
        data: modernization_hours_data,
        color: "#FF0000",
...
var modernization_hours_options = {
    series: {
        shadowSize: 5
    },
    xaxes: [{
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-modernization-hours-by-customer"), modernization_hours_dataset, modernization_hours_options);
    $("#flot-placeholder-modernization-hours-by-customer").UseTooltip();
});
