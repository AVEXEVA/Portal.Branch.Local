...
function gd(year, month, day) {
    ...
    var testing_hours_dataset = [
    {
        label: "Profit",
        data: testing_hours_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-testing-hours-by-customer"), testing_hours_dataset, testing_hours_options);
    $("#flot-placeholder-testing-hours-by-customer").UseTooltip();
});
