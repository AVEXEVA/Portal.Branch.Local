...
<div class="panel panel-primary">
	<div class='panel-heading'><?php $Icons->Blank( 1 );?> Timeline</div>
			...
			if(count($Timeline) > 0){foreach($Timeline as $Date=>$DayTimeline){
				...
				foreach($DayTimeline as $Instance){
					...
					if(substr($Instance['Object'],0,6) == 'Ticket' && $Instance['Field'] == 'Completed'){
						...
						?><div class='col-md-12'><a href='invoice.php?ID=<?php echo $Instance['ID'];?>'><?php $Instance['Date'];?> <?php $Icons->Violation();?> Overdue Invoice #<?php echo $Instance['ID'];?></a></div><?php
					}
				}
			}}
		?></div>
