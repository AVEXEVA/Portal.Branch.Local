...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    if(!isset($_SESSION['Branch']) || $_SESSION['Branch'] == 'Nouveau Elevator'){
        ...
        elseif($My_Privileges['Customer']['User_Privilege'] >= 4 && $My_Privileges['Ticket']['Group_Privilege'] >= 4 ){
        	$database->queryAc($Portal,"INSERT INTO Activity([User], [Date], [Page]) VALUES(?,?,?);",array($_SESSION['User'],date("Y-m-d H:i:s"), "customer.php"));
...
<div class="tab-pane fade in" id="sales-pills">
	<ul class="nav nav-tabs BankGothic">
		<li class=""><a href="#" onClick="asyncSubPage(this);" main='sales-pills' tab='sales-overview-pills'>Overview</a></li>
		<li class=""><a href="#" onClick="asyncSubPage(this);" main='sales-pills' tab='sales-contracts-pills' >Contracts</a></li>
		<li class=""><a href="#" onClick="asyncSubPage(this);" main='sales-pills' tab='sales-proposals-pills' >Proposals</a></li>
	</ul>
	<div class="tab-content sales-pills" id='sub-tab-content'>
...
$(document).ready(function(){
	...
	$("#sales-pills").addClass('active');
	$("a[tab='sales-overview-pills']").click();
});
</script>
<?php
    }
