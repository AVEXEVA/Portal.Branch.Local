<li>
    ...
    <ul class="nav nav-third-level collapse">
        ...
        <li>
            <a href="testing.php"><?php \singleton\fontawesome::getInstance( )->Job();?> <span class=''>Summary</span></a>
        </li>
        <?php }?>
        ...
        <li>
            <a href="due_violations.php"><?php \singleton\fontawesome::getInstance( )->Job();?> <span class=''>Due Violations</span></a>
        </li>
        <?php }?>
    </ul>
</li>