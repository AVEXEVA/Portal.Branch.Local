<li>
    ...
    <ul class="nav nav-third-level collapse">
        ...
        <li>
            <a href="maintenance.php"><?php \singleton\fontawesome::getInstance( )->Job();?> <span class=''>Summary</span></a>
        </li>
        <?php }?>
        ...
        <li>
            <a href="maintenances.php"><?php \singleton\fontawesome::getInstance( )->Job();?> <span class=''>Required Work</span></a>
        </li>
		<li>
            <a href="service_calls.php"><?php \singleton\fontawesome::getInstance( )->Phone();?> <span class=''>Service Calls</span></a>
        </li>
        <?php }?>
    	
        
        <!--<li>
            <a href="modernizations.php"><?php \singleton\fontawesome::getInstance( )->Job();?> Jobs</a>
        </li>-->
    </ul>
</li>