...
<div class='tab-pane fade in' id='tables-loans-pills'>
	<div class="panel panel-primary" style='margin-bottom:0px;'>
		<div class="panel-body">
			<div class="row">
				<div class='col-md-12' >
					<div class="panel panel-primary">
						<div class="panel-heading"><h3><i class="fa fa-bell fa-fw"></i> Loans Table</h3></div>
						<div class="panel-body white-background BankGothic shadow">
							...
							<table id='Table_Loans' class='display' cellspacing='0' width='100%'>
                                <thead>
                                    <th></th>
                                    <th></th>
                                    <th></th>
				...
				<script>
					...
					var Editor_Loans = new $.fn.dataTable.Editor({
						ajax: "php/post/Loan.php?ID=<?php echo $_GET['ID'];?>",
						table: "#Table_Loans",
						template: '#Form_Loan',
						formOptions: {
							inline: {
					...
					Editor_Loans.field('Invoice').disable();
					Editor_Loans.field('Invoice').hide();
					$('#Table_Loans').on( 'click', 'tbody td:not(:first-child)', function (e) {
						Editor_Loans.inline( this );
					} );
					var Table_Loans = $('#Table_Loans').DataTable( {
						"ajax": {
							"url":"php/get/Loans.php",
						...
						"buttons":[
							{
								...
								action:function(e,dt,node,config){
									document.location.href = 'invoice.php?ID=' + $("#Table_Loans tbody tr.selected td:nth-child(2)").html();
								}
							},{ 
								text : "Preview",
								action:function(e,dt,node,config){
...
$(document).ready(function(){
	...
	$("#tables-loans-pills").addClass('active');
});
</script>
<?php
    }
