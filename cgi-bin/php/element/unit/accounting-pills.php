...
?>
<div class="tab-pane fade in" id="accounting-pills">
	<ul class="nav nav-tabs BankGothic">
		<li><a href='#' onClick="asyncSubPage(this);" main='accounting-pills' tab='accounting-overview-pills'>Overview</a></li>
		<li><a href='#' onClick="asyncSubPage(this);" main='accounting-pills' tab='accounting-collections-pills'>Collections</a></li>
		<li><a href='#' onClick="asyncSubPage(this);" main='accounting-pills' tab='accounting-revenue-pills'>Revenue</a></li>
		<li><a href='#' onClick="asyncSubPage(this);" main='accounting-pills' tab='accounting-expenses-pills'>Expenses</a></li>
		<li><a href='#' onClick="asyncSubPage(this);" main='accounting-pills' tab='accounting-profit-pills'>Profit</a></li>
	</ul>
	<div class="tab-content accounting-pills" id='sub-tab-content'>
...
$(document).ready(function(){
	...
	$("#accounting-pills").addClass('active');
	$("a[tab='accounting-overview-pills']").click();
});
</script>
<?php
    }
