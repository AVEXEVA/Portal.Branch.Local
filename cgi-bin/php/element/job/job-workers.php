...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
	...
	var Table_Workers = $('#Table_Workers').DataTable( {
		"ajax": "cgi-bin/php/get/Workers_by_Job.php?ID=<?php echo $_GET['ID'];?>",
		"columns": [
			{ "data" : "ID"
			},{
				"data" : "First_Name"
		...
		"buttons":[
			...
			{ text:"View",
			  action:function(e,dt,node,config){
				  document.location.href = 'user.php?ID=' + $("#Table_Units tbody tr.selected td:first-child").html();
			  }
			}
		],
		"language":{
	...
	function hrefWorkers(){hrefRows("Table_Workers","user");}
