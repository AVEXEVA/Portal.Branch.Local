			...
			<div class='row'>
				...
				<div class='col-md-12' style=''>
					<div class="panel panel-primary">
						...
						<div class='panel-body white-background BankGothic shadow'>
							<table id='Table_Revenue_Invoices_2' class='display' cellspacing='0' width='100%'>
								<thead>
...
<script>
function hrefInvoices(){hrefRow("Table_Revenue_Invoices_2","invoice");}
var Table_Invoices = $('#Table_Revenue_Invoices_2 ').DataTable( {
