  ...
  <div class='panel-primary'>
    ...
    <div class='panel-body'>
      ...
      var Table_Jobs = $('#Table_Jobs').DataTable( {
    		"ajax": "cgi-bin/php/get/Jobs.php?<?php echo isset($_GET['Location']) ? "Loc={$_GET['Location']}" : '';?>",
    		"processing":true,
    		"serverSide":true,
        "columns": [
  				{
      ...
      function selectJob(tbl){
        ...
        $("table#Table_Jobs tbody tr").each(function(){
          $(this).on('click',function(){
            document.location.href='purchase-requisition.php?Job=' + tbl.row(this).data()[0] + '<?php
