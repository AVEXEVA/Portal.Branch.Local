...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
  ...
  if(!isset($array['ID'])  || !$Privileged){?><html><head>
    ...
    if(isset($_POST['ID']) && !isset($_POST['Item'])){
      //INSERT BLANK RECORD INTO Item, Product & Door_Operator
      //Insert into Product
      $sQuery =
        " INSERT INTO Device.dbo.Product(Name, Manufactrer)
          VALUES(?, ?);";
      $params = array(
        $_POST['Product'],
        $_POST['Manufacturer']
      ...
      //Insert into Door_Operator
      $sQuery =
        " INSERT INTO Device.dbo.[Door_Operator](Item, Speed, Hand)
          VALUES(?, ?, ?);";
      $params = array($Item_ID, $_POST['Speed'], $_POST['Hand']);
      $r = sqlsrv_query($database_Device, $sQuery, $params);
      ...
      $r = sqlsrv_query($database_Device, $sQuery, $params);
      //Update Door_Operator
      $sQuery =
        " UPDATE  Device.dbo.[Door_Operator]
          SET     Door_Operator.Speed = ?,
                  Door_Operator.Hand = ?
          WHERE   Door_Operator.Item = ?;";
      $params = array(
        $_POST['Speed'],
        $_POST['Hand'],
        $_POST['Item']
