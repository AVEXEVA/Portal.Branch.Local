...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
  ...
  <?php } else {
    if(isset($_POST['ID']) && !isset($_POST['Item'])){
      //INSERT BLANK RECORD INTO Item, Product & Drive
      //Insert into Product
      $sQuery =
      ...
      //Insert into Drive
      $sQuery =
        " INSERT INTO Device.dbo.[Drive](Item, [Input_Voltage], [Input_Amperage], [Output_Voltage], [Output_Amperage], [Horsepower])
          VALUES(?, ?, ?, ?, ?, ?, ?);";
      $params = array(
        $Item_ID,
        $_POST['Type'],
      ...
      //Update Drive
      $sQuery =
        " UPDATE  Device.dbo.Drive
          SET     Drive.Type = ?,
                  Drive.Input_Voltage = ?,
                  Drive.Input_Amperage = ?,
                  Drive.Output_Voltage = ?,
                  Drive.Output_Amperage = ?,
                  Drive.Horsepower = ?
          WHERE   Drive.Item = ?";
      $params = array($_POST['Type'], $_POST['Input_Voltage'], $_POST['Input_Amperage'], $_POST['Output_Voltage'], $_POST['Output_Amperage'], $_POST['Horsepower'], $_POST['Item']);
      $r = sqlsrv_Query($database_Device, $sQuery, $params);
