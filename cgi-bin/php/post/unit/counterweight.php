...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
  ...
  <?php } else {
    if(isset($_POST['ID']) && !isset($_POST['Item'])){
      //INSERT BLANK RECORD INTO Item, Product & Counterweight
      //Insert into Product
      $sQuery =
      ...
      //Insert into Counterweight
      $sQuery =
        " INSERT INTO Device.dbo.[Counterweight](Item)
          VALUES(?);";
      $params = array(
        $Item_ID
      );
      ...
      //$sQuery = "UPDATE Device.dbo.Counterweight SET Counterweight.[Type] = ?, Counterweight.[Power] = ?, Counterweight.[Mounting_Pad] = ? WHERE Counterweight.Item = ?";
      //$params = array($_POST['Type'], $_POST['Power'], $_POST['Mounting_Pad'], $_POST['Item']);
      //$r = sqlsrv_Query($database_Device, $sQuery, $params);
