...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
  ...
  <?php } else {
    if(isset($_POST['ID']) && !isset($_POST['Item'])){
      //INSERT BLANK RECORD INTO Item, Product & Generator
      //Insert into Product
      $sQuery =
      ...
      $sQuery =
        " INSERT INTO Device.dbo.[Generator](Item, [Power_Input], [Input_Voltage], [Input_Amperage], [Power_Output], [Output_Voltage], [Output_Amperage], [Wattage_Rating], [RPM], [Horsepower], [Windings])
          VALUES(?, ?, ?, ?, ?, ? ,? ,? ,? ,? ,?);";
      $params = array(
        $Item_ID,
        $_POST['Power_Input'],
        ...
        $_POST['Output_Amperage'],
        $_POST['Wattage_Rating'],
        $_POST['RPM'],
        $_POST['Horsepower'],
        $_POST['Windings']
      );
      ...
      //Update Generator
      $sQuery =
        " UPDATE  Device.dbo.Generator
          SET     Generator.Power_Input = ?,
                  Generator.Input_Voltage = ?,
                  Generator.Input_Amperage = ?,
                  Generator.Power_Output = ?,
                  Generator.Output_Voltage = ?,
                  Generator.Output_Amperage = ?,
                  Generator.Wattage_Rating = ?,
                  Generator.RPM = ?,
                  Generator.Horsepower = ?,
                  Generator.Windings = ?
          WHERE   Generator.Item = ?";
      $params = array(
        $_POST['Power_Input'],
        $_POST['Input_Voltage'],
        $_POST['Input_Amperage'],
