...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
  ...
  if(!isset($array['ID'])  || !$Privileged){?><html><head>
    ...
    if(isset($_POST['ID']) && !isset($_POST['Item'])){
      //INSERT BLANK RECORD INTO Item, Product & Hall_Lantern
      //Insert into Product
      $sQuery =
      ...
      //Insert into Hall_Lantern
      $sQuery =
        " INSERT INTO Device.dbo.[Hall_Lantern](Item, [Floor], [Type])
          VALUES(?, ?, ?);";
      $params = array(
        $Item_ID,
        $_POST['Floor'],
      ...
      //Update Hall_Lantern
      $sQuery =
        " UPDATE  Device.dbo.[Hall_Lantern]
          SET     Hall_Lantern.[Floor] = ?,
                  Hall_Lantern.[Type] = ?
          WHERE   Hall_Lantern.Item = ?";
      $params = array(
        $_POST['Floor'],
        $_POST['Type'],
        $_POST['Item']
