...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
  ...
  $r = $database->query(null,"SELECT PDATicketSignature.Signature AS Signature FROM nei.dbo.PDATicketSignature WHERE PDATicketSignature.PDATicketID = ?",array($_GET['ID']));
  if($r){while($array = sqlsrv_fetch_array($r)){$Ticket['Signature'] = $array['Signature'];}}?>
<div class='popup Ticket' class='' style='width:900px;font-size:12px !important;background-color:white;height:80% !important;z-index:99;overflow-y:scroll;'>
