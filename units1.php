				...
				<div class='card-body bg-dark'>
					<table id='Table_Units' class='display' cellspacing='0' width='100%'>
						<thead><tr class='text-center'>
							...
							<th class='text-white border border-white' title='City ID'>City ID</th>
							...
							<th class='text-white border border-white' title='Building ID'>Building ID</th>
							...
							<th class='text-white border border-white' title='City_ID'><input class='redraw form-control' type='text' name='City_ID' value='<?php echo isset( $_GET[ 'City_ID' ] ) ? $_GET[ 'City_ID' ] : null; ?>' placeholder='City ID' /></th>
							...
							<th class='text-white border border-white' title='Building_ID'><input class='redraw form-control' type='text' name='Building_ID' value='<?php echo isset( $_GET[ 'Building_ID' ] ) ? $_GET[ 'Building_ID' ] : null; ?>' placeholder='Building ID' /></th>
