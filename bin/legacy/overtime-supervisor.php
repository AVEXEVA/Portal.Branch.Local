            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading"><h3><div style='float:left;'><?php \singleton\fontawesome::getInstance( )->Timesheet();?>PIVOT: Employee Supervisor - <?php echo $_GET['Start'];?> to <?php echo $_GET['End'];?></div><div style='float:right;'><button onClick="document.location.href='overtime.php';" style='color:black;'>Job Supervisor</button></div><div style='float:right;'><button onClick="document.location.href='overtime-employee.php';" style='color:black;'>Employee</button></div><div style='clear:both;'></div></h3></div>
