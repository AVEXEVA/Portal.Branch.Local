...
function gd(year, month, day) {
    ...
    var repair_jobs_dataset = [
    {
        label: "Count of Jobs",
        data: repair_jobs_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-repair-jobs"), repair_jobs_dataset, repair_jobs_options);
    $("#flot-placeholder-repair-jobs").UseTooltip();
});
