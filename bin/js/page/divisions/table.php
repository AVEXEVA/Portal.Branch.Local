...
$( document ).ready( function( ){
  var Table_Divisions = $('#Table_Divisions').DataTable( {
    ...
    columns: [
      ...
      <?php \singleton\datatables::getInstance( )->data_column_count( 'Units_Elevators', 'Division', 'ID', 'Unit', 'units','Type=Elevator' );?>,
      <?php \singleton\datatables::getInstance( )->data_column_count( 'Units_Escalators', 'Division', 'ID', 'Unit', 'units','Type=Escalator' );?>,
