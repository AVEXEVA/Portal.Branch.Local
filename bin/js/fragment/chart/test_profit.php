...
function gd(year, month, day) {
    ...
    var test_profit_dataset = [
    {
        label: "Profit",
        data: test_profit_data,
        color: "#FF0000",
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-test-profit"), test_profit_dataset, test_profit_options);
    $("#flot-placeholder-test-profit").UseTooltip();
});
