...
function gd(year, month, day) {
    ...
    var no_job_type_profit_profit_dataset = [
    {
        label: "Profit",
        data: no_job_type_profit_profit_data,
        color: "#FF0000",
...
var no_job_type_profit_profit_options = {
    series: {
        shadowSize: 5
    },
    xaxes: [{
...
$(document).ready(function () {
    $.plot($("#flot-placeholder-no-job-type-profit"), no_job_type_profit_profit_dataset, no_job_type_profit_profit_options);
    $("#flot-placeholder-no-job-type-profit").UseTooltip();
});
