...
$(function() {
    var data43 = [<?php 
        ...
        $job_result = $database->query(null,"
            ...
            WHERE Job.Type = '8' AND TicketD.EDate >= '2017-03-30 00:00:00.000' AND TicketD.Total <= 24
        ...
        echo implode(",",$data2);?>];
    var plotObj3 = $.plot($("#flot-pie-chart-testing-jobs-hours-by-supervisor"), data43, {
        series: {
            pie: {
                show: true
            }
