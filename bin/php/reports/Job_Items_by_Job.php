...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    $Privileged = FALSE;
    if(isset($My_Privileges['Job']) && $My_Privileges['Job']['Owner'] >= 4 && $My_Privileges['Invoice']['Group'] >= 4 && $My_Privileges['Job']['Other'] >= 4){$Privileged = TRUE;}
