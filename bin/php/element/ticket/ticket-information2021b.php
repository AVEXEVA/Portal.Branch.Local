...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    if(!isset($_SESSION['Branch']) || $_SESSION['Branch'] == 'Nouveau Elevator'){
        ...
        elseif($My_Privileges['Ticket']['Owner'] >= 6 && !isset($_GET['ID'])){$Privileged = TRUE;}
...
<div class="panel panel-primary">
  ...
  <div class='panel-body' style='padding:10px;'>
    ...
    <div class='row resolution'>
      ...
      <div class='col-xs-12'><select name='Resolution_Code' multiple style='width:100%;height:250px;'>
        <?php
    ...
    <div class='row'>
      <div class='col-xs-12'>&nbsp;</div>
      <div class='col-xs-12'><textarea disabled id='TextareaResolution' name='Resolution' style='width:100%;font-family:monospace;' rows='5' placeholder='Resolution Description'><?php echo $Ticket2['DescRes'];?></textarea></div>
      <div class='col-xs-12'>&nbsp;</div>
      <div class='col-xs-12'><button style='width:100%;' onClick='clear_Resolution();'>Clear Resolution</button></div>
      <script>function clear_Resolution(){$('#TextareaResolution').val('');}</script>
    </div>
...
<?php require("../../../../bin/js/pages/ticket2021b.php");?>
<style>
