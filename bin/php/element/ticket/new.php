										...
										<div class='row'>
											...
											<div class='col-md-12'>
												  ...
												  $(document).ready(function(){
													$("input[name='Location_Name']").autocomplete({
													  ...
													  select: function( event, ui ) {
														...
														$.ajax({
															url:"bin/php/get/Customer_by_Location.php?ID=" + ui.item.value,
															method:"GET",
												...
												function lookupLocations(link){
												  $.ajax({
													  method:"GET",
													  url:"bin/php/element/ticket/Location_by_Customer.php?ID=" + $(link).siblings('input').val(),
													  success:function(code){
											...
											<div class='col-md-12'>
												...
												$(document).ready(function(){
													$("input[name='Job_Name']").autocomplete({
													  ...
													  select: function( event, ui ) {
														...
														$.ajax({
															url:"bin/php/get/Customer_by_Job.php?ID=" + ui.item.value,
															method:"GET",
															success:function(code){
																var json = eval("("+code+")");
																$("input[name='Customer_Name']").val(json.data[0].Customer_Name);
												...
												function lookupJobs(link){
												  $.ajax({
													  method:"GET",
													  url:"bin/php/element/ticket/Job_by_Location.php?ID=" + $(link).siblings('input').val(),
													  success:function(code){
											...
											<div class='col-md-12'>
												  ...
												  $(document).ready(function(){
													$("input[name='Unit_Name']").autocomplete({
													  ...
													  select: function( event, ui ) {
														...
														$.ajax({
															url:"bin/php/get/Location_by_Unit.php?ID=" + ui.item.value,
															method:"GET",
															success:function(code){
																var json = eval("("+code+")");
																...
																$.ajax({
																	url:"bin/php/get/Customer_by_Location.php?ID=" + json.data[0].Location_ID,
																	method:"GET",
																	success:function(code){
																		var json = eval("("+code+")");
																		$("input[name='Customer_Name']").val(json.data[0].Customer_Name);
												...
												function lookupUnits(link){
												  $.ajax({
													  method:"GET",
													  url:"bin/php/element/ticket/Unit_by_Job.php?ID=" + $(link).siblings('input').val(),
													  success:function(code){
