		...
		<div class="panel-body">
			<div class="row">
						...
						<div class="panel-body">
							<table id='Table_Invoices' class='display' cellspacing='0' width='100%' style='font-size:12px;'>
								<thead>
									...
									<?php if(!isMobile()){?><th title='Description of the Invoice'>Description</th><?php }?>
				...
				var Table_Invoices = $('#Table_Invoices').DataTable( {
					"ajax": "bin/php/get/Invoices_by_Job.php?ID=<?php echo $_GET['ID'];?>",
					"columns": [
						{ "data" : "ID" },
						{ "data" : "Job"},
						{ "data" : "Location"},
						...
						<?php if(!isMobile()){?>{ "data" : "Description"},<?php }?>
						{
							"data" : "Total",
							"width":"50px",
							render:function(data){return "$" + parseFloat(data).toLocaleString();}
