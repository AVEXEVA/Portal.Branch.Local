							...
							<div class="panel panel-primary">
								...
								<div class="panel-body white-background">
									...
									var Table_Worker_Feed = $('#Table_Worker_Feed').DataTable( {
										"ajax": {
												"url": "bin/php/reports/Worker_Feed_by_Job.php?ID=<?php echo $_GET['ID'];?>",
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body white-background">
									...
									var Table_Service_Call_Feed = $('#Table_Service_Call_Feed').DataTable( {
										"ajax": {
												"url": "bin/php/reports/Service_Call_Feed_by_Job.php?ID=<?php echo $_GET['ID'];?>",
												"dataSrc":function(json){if(!json.data){json.data = [];}return json.data;}
										},
										"columns": [
											{
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body white-background shadow" style='height:500px;overflow-y:scroll;'>
									...
									$(document).ready(function(){
										$.ajax({
											url:"bin/php/element/job/operations-overview-job-hours.php?ID=<?php echo $_GET['ID'];?>",
											method:"GET",
