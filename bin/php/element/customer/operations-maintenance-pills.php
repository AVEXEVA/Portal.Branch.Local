			...
			<div class='row'>
					...
					<div class='row'>
						...
						<div class='col-md-12' style=''>
							...
							var Table_Active_Maintenance = $('#Table_Active_Maintenance').DataTable( {
								"ajax": "bin/php/reports/Active_Maintenance_by_Customer.php?ID=<?php echo $_GET['ID'];?>",
								"columns": [
									{ "data": "ID"},
									{ "data": "Name" },
				...
				<div class='col-md-6' style=''>
					<div class='row'>
						<div class='col-md-12' style=''>
							<div class="panel panel-primary">
								<div class="panel-heading"><h3><?php \singleton\fontawesome::getInstance( )->Territory();?>Location Maintenance</h3></div>
								<div class='panel-body white-background BankGothic shadow'>
							...
							var Table_Division_Route = $('#Table_Division_Route').DataTable( {
								"ajax": "bin/php/reports/Division_Route_by_Owner.php?ID=<?php echo $_GET['ID'];?>",
								"columns": [
									{ "data": "Location_Name" },
									{ "data": "Division_Name"},
						...
						<div class='col-md-12' style=''>
							...
							var Table_Required_Maintenance = $('#Table_Required_Maintenance').DataTable( {
								"ajax": {
									"url":"bin/php/reports/Maintenances_by_Customer.php?ID=<?php echo $_GET['ID'];?>",
