			...
			<div class="row">
				<div class='col-md-12' >
					<div class="panel panel-primary">
						<div class="panel-heading"><h3><?php \singleton\fontawesome::getInstance( )->Phone();?> Service Calls Table</h3></div>
				...
				<script>
					var Table_Tickets_Service_Calls = $('#Table_Tickets_Service_Calls').DataTable( {
						"ajax": {
							"url":"bin/php/get/Tickets_by_Customer_Service_Calls.php?ID=<?php echo $_GET['ID'];?>",
