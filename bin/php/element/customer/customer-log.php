...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    $database->query($Portal,"INSERT INTO Activity([User], [Date], [Page]) VALUES(?,?,?);",array($_SESSION['User'],date("Y-m-d H:i:s"), "customer-log.php"));
			...
			<div class="row">
				<div class='col-md-12' >
					...
					var Table_Log = $('#Table_Log').DataTable( {
						"ajax": {
							"url":"bin/php/get/Log_by_Customer.php?ID=<?php echo $_GET['ID'];?>",
