...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    $database->query($Portal,"INSERT INTO Activity([User], [Date], [Page]) VALUES(?,?,?);",array($_SESSION['User'],date("Y-m-d H:i:s"), "customer-information.php"));
		...
		<div class="panel-body">
			<div class="row">
				...
				var Table_Proposals = $('#Table_Proposals').DataTable( {
					"ajax": "bin/php/get/Proposals_by_Customer.php?ID=<?php echo $_GET['ID'];?>",
					"columns": [
