                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                            ...
                            <form action="modernization_tracker.php" method="POST" id='Add_Modernization_Task' enctype="multipart/form-data" > 
                                ...
                                <table>
                                    <tr>
                                        <td>Task:</td>
                                        <td><select name='Task'>
                                            <?php $r = $database->query(null,"SELECT * FROM Portal.dbo.Tasks ORDER BY Tasks.Name ASC;");
                        ...
                        function addModernizationTask(){
                            ...
                            $.ajax({
                                url:"bin/php/post/addModernizationTask.php?ID=<?php echo $_GET['ID'];?>",
                                method:"POST",
                                data:formdata,
                                success:function(code){
                                    $(".popup").remove();
                                    $.ajax({
                                        url:"bin/php/element/modernization/modernization_tracker.php?ID=<?php echo $_GET['ID'];?>",
                                        method:"GET",
                                        success:function(code){
