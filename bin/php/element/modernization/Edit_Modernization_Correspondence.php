                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        function updateModernizationEquipmentCorrespondence(){
                            ...
                            $.ajax({
                                url:"bin/php/post/updateModernizationEquipmentCorrespondence.php?ID=<?php echo $_GET['ID'];?>",
                                method:"POST",
                                data:formdata,
                                success:function(code){
                                    $(".popup").remove();
                                    $.ajax({
                                        url:"bin/php/element/modernization/modernization_equipment.php?ID=<?php echo $_GET['Ref'];?>",
                                        method:"GET",
                                        success:function(code){
