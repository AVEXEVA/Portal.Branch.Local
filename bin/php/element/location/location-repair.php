...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
        ...
        if($job_result){
            ...
            $SQL_Jobs = implode(" OR ",$Jobs);
							...
							<div class="panel panel-primary">
								<!--<div class="panel-heading"><h4><?php \singleton\fontawesome::getInstance( )->Modernization();?>Active Repair</h4></div>-->
   ...
   <script>
    var Table_Active_Repair = $('#Table_Active_Repair').DataTable( {
        "ajax": "bin/php/get/Active_Repair_by_Location.php?ID=<?php echo $_GET['ID'];?>",
        "columns": [
            { "data": "ID"},
            { "data": "Name" },
