                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td><select id='selectLocation' name='Location' onchange="if(this.selectedIndex && this.val != 0) lookupJobs(this);">
                                            ...
                                            <?php 
                                                $r = $database->query(null,"SELECT Loc.Loc, Loc.ID, Loc.Tag as Tag FROM Loc INNER JOIN Job ON Job.Loc = Loc.Loc WHERE Maint='1' AND Job.Type='2' ORDER BY 3 ASC");
                        ...
                        function addModernizationEquipment(){
                            ...
                            $.ajax({
                                url:"bin/php/post/addModernizationEquipmentbyPurchasing.php?ID=<?php echo $_GET['ID'];?>",
                                method:"POST",
                                data:formdata,
