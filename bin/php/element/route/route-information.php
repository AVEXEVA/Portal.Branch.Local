...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    $Privileged = FALSE;
    if(isset($array['ID'],$My_Privileges['Route']) && $My_Privileges['Route']['Owner'] >= 4 && $My_Privileges['Route']['Group'] >= 4 && $My_Privileges['Route']['Other'] >= 4){$Privileged = TRUE;}
    else {
...
?><div class="panel panel-primary">
	...
	<div class='panel-body white-background'>
		<div class='row shadower ' style='font-size:16px;padding:5px;'>
            ...
            <div class='col-xs-8'><?php if($My_Privileges['Route']['Other'] >= 4 || $My_User['ID'] == $Route['Route_Mechanic_ID']){?><a href="route.php?ID=<?php echo $Route['Route_ID'];?>"><?php }?><?php echo proper($Route["Route_Mechanic_First_Name"] . " " . $Route["Route_Mechanic_Last_Name"]);?><?php if($My_Privileges['Route']['Other'] >= 4 || $My_User['ID'] == $Route['Route_Mechanic_ID']){?></a><?php }?>
			</div>
