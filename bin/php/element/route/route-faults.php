...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    $Privileged = FALSE;
    if(isset($My_Privileges['Route']) && $My_Privileges['Route']['Owner'] >= 4 && $My_Privileges['Route']['Group'] >= 4 && $My_Privileges['Route']['Other'] >= 4){$Privileged = TRUE;}
    else {
...
?>
            ...
            var Table_Maintenances = $('#Table_Maintenances').DataTable( {
                "ajax": "bin/php/get/CM_Faults_by_Route.php?ID=<?php echo $_GET['ID'];?>",
                "columns": [
                    {
          						"data": "Location"
          					},{
