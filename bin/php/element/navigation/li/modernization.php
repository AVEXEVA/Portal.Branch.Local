<li>
    ...
    <ul class="nav nav-third-level collapse">
        ...
        <li>
            <a href="modernization.php"><?php \singleton\fontawesome::getInstance( )->Job();?> <span class=''>Summary</span></a>
        </li>
        <?php }?>
        ...
        <li>
            <a href="modernizations.php"><?php \singleton\fontawesome::getInstance( )->Job();?> <span class=''>Jobs</span></a>
        </li>
	   <li>
            <a href="modernization_tracker.php"><?php \singleton\fontawesome::getInstance( )->Job();?> <span class=''>Tracker</span></a>
        </li>
        <?php }?>
    </ul>
</li>