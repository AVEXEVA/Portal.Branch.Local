...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
  ...
  if(!$Privileged
    ...
    ");
    $r2 = $database->query(null,"SELECT * FROM Loc WHERE Loc.Loc = ?",array($_POST['Location']));
