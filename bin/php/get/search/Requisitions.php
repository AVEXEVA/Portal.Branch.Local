...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
	...
	$Privileged = False;
	if( isset($Privileges['Requisitions'])
        && (
				$Privileges['Requisitions']['User_Privilege'] >= 4
			||	$Privileges['Requisitions']['Group_Privilege'] >= 4
			||	$Privileges['Requisitions']['Other_Privilege'] >= 4)){
            	$Privileged = True;
    }
