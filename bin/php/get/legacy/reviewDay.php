...
if( isset( $_SESSION[ 'User' ], $_SESSION[ 'Hash' ] ) ){
    ...
    if(!isset($Connection['ID']) || !$Privileged){print json_encode(array('data'=>array()));}
      ...
      $data = array( );
      $html = "<tr class='tickets' style='background-color:black !important;color:white !important;'><td colspan='20'>Tickets for the Day of " . date( 'm/d/Y', strtotime( $_GET[ 'Date' ] ) ) . "</td></tr>";
