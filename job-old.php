...
<body onload='finishLoadingPage();' style="min-height:100%;background-size:cover;background-color:#1d1d1d;height:100%;color:white;">
    ...
    <div id="wrapper" class="<?php echo isset($_SESSION['Toggle_Menu']) ? $_SESSION['Toggle_Menu'] : null;?>" style='height:100%;'>
		...
		<div class="panel-heading"><h3><?php $Icons->Job();?>Job: <?php echo $Job['Job_Name'];?></h3></div>
		<script>
		...
		<div class="panel-body">
			<ul class="nav nav-tabs BankGothic">
				...
				<?php if(isset($My_Privileges['Customer']) && $My_Privileges['Customer']['Other_Privilege'] >= 4){?><li class=''><a href='#' tab='sales-pills' onClick='asyncPage(this);'><?php $Icons->Sales();?>Sales</a></li><?php }?>
				<?php if((!isset($_SESSION['Branch']) || $_SESSION['Branch'] == 'Nouveau Elevator') && (isset($My_Privileges['Financials']) && $My_Privileges['Financials']['Other_Privilege'] >= 4)){?><li class=''><a href='#' tab='accounting-pills' onClick='asyncPage(this);'><?php $Icons->Collection();?>Accounting</a></li><?php }?>
